...
docker run --name=nginx --volumes-from approot --volumes-from nginx_config_root  --volumes-from nginx_log_root --link php-fpm:php -p 8081:8081 -p 8888:8888 -p 8082:8082 -p 8083:8083 -p 8484:8484 -p 80:80 -d dockerhub:5000/nginx
